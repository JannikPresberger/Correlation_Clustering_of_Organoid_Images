...
int main() {
    ...
    std::string filePath = "/run/media/dstein/Elements/new-models/models-w-species-list/similarity/birdclef-song-AB-600-2s-frame-no-overlap-no-denoise-sns-50-nfft1024-nmels128-zscore-no-augments-resnet18/analysis/siamese_outputs_unseen_only.csv";
    std::string classesFilePath = "/run/media/dstein/Elements/new-models/models-w-species-list/similarity/birdclef-song-AB-600-2s-frame-no-overlap-no-denoise-sns-50-nfft1024-nmels128-zscore-no-augments-resnet18/analysis/siamese_outputs_unseen_only_classes.csv";
...
//            "/run/media/dstein/Elements/new-models/models-w-species-list/similarity/birdclef-song-AB-600-2s-frame-no-overlap-no-denoise-sns-50-nfft1024-nmels128-zscore-with-augments-resnet18",test
