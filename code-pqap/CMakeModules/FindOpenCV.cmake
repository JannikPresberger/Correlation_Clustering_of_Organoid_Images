...
if(MSVC)
message(STATUS "in MSVC ${MSVC_VERSION}")
  if(CMAKE_CL_64)
    set(OpenCV_ARCH x64)
  ...
  elseif(MSVC_VERSION EQUAL 1934)
    ...
    message(WARNING "unrecognised MSVC_VERSION: ${MSVC_VERSION}! To resolve this manually add the MSVC_Version to the FindOpenCV.cmake file")
  endif()
elseif(MINGW)
